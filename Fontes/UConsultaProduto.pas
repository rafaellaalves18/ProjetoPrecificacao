...
implementation
  ...
  uses Udados, UFuncoes, USimulacaoPreco, UCadProduto, UConsultaSimulacao;
...
else if (FrmConsultaProduto.iTag = 2) then
begin

   FrmCadProduto.iCodigoProduto     := strToint(qryconsultaprodCODIGO_PRODUTO.AsString);
   FrmCadProduto.CODIGO_PRODUTOExit(nil);
...
begin
   FrmConsultaSimulacao.txtcodproduto.Text := qryconsultaprodCODIGO_PRODUTO.AsString;
   FrmConsultaSimulacao.btnPesquisarClick(nil);
   self.Close;
